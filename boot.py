...
#==================== CONFIGURATION =====================
LOCAL_FOLDER_PATH = r"C:\Users\bbc tech\OneDrive\Documents\OneNote Notebooks" # Change this to your local folder path
GOOGLE_DRIVE_FOLDER_ID = "client_secrets.json"  # Change this to your Drive folder ID
BATCH_SIZE = 5
